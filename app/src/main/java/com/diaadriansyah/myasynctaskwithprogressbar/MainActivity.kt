package com.diaadriansyah.myasynctaskwithprogressbar
...
class MainActivity : AppCompatActivity() {
    companion object{
        private const val DEMO_ASYNC = "Demo Async With Progress"
        // Maksimum nilai dari progress 10000
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_start.setOnClickListener {
            ...
            Toast.makeText(this, "Async masih berjalan, silahkan tunggu sampai selesai..", Toast.LENGTH_SHORT).show()
            GlobalScope.launch{
                doInBackground()
            }
